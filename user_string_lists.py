...
with open("about_yoga.txt", "r") as fileObject:
...
print(f"Minimum location and maximum location:", min_loc , max_loc)
...
ready_for_continous_level_checks = False  # change this when ready
